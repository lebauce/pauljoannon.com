            ...
            const update = () => {
                ...
                links.each(function () {
                    ...
                    d3.select(this).select(() => {
                        ...
                        if (e == null) e = this.appendChild(document.createElement('span'));
                        return e;
    ...
    (() => {
        ...
        if (container != null) {
            ...
            const update = () => {
                ...
                exited.remove();
                entered.append('span').attr('class', 'year').append('span').attr('class', 'year__label').html(d => `${d}<br>`);
